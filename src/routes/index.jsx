...
function Home() {
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-12">
          <div className="animate-fade-up">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <a
    href={waLink("Hi Softcare Solutions! I'd like to chat about a repair.")}
    target="_blank"
    rel="noreferrer"
    ...
    { k: "Same-day", v: "Most repairs" }
  ].map((s) => <div key={s.v} className="rounded-xl border border-border bg-card/50 p-3 text-center">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl border border-border shadow-card">
              <img
    src={heroImg}
    alt="Samsung phones with internal parts"
    width={1600}
    height={1024}
  ...
  ].map((f) => <div key={f.t} className="glass card-hover rounded-xl p-5">
    ...
    /* SERVICES */
      ...
      <Section eyebrow="What we do" title="Repairs & services" subtitle="From cracked screens to motherboard-level diagnostics — all handled in our Nairobi CBD lab.">
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-3">
          {services.map((s) => <div key={s.label} className="card-hover group rounded-2xl border border-border bg-card p-6">
      ...
      <Section eyebrow="About us" title="A smarter way to fix your phone">
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div className="overflow-hidden rounded-2xl border border-border shadow-card">
            <img
    src={workspaceImg}
    alt="Technician repairing a Samsung phone"
    loading="lazy"
    width={1280}
    height={960}
  ...
  ].map((i) => <li key={i} className="flex items-start gap-2"><BadgeCheck className="mt-0.5 h-4 w-4 text-primary" /> {i}</li>)}
            </ul>
    ...
    /* FEATURED PHONES */
      ...
      <Section eyebrow="In stock now" title="Featured phones" subtitle="New and quality refurbished smartphones — mostly Samsung.">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
    { img: phoneS23, name: "Samsung Galaxy S23 Ultra", spec: "256GB \xB7 12GB RAM", cond: "New", price: "KSh 145,000" },
    { img: phoneA54, name: "Samsung Galaxy A54 5G", spec: "128GB \xB7 8GB RAM", cond: "New", price: "KSh 42,000" },
    { img: phoneIph, name: "Apple iPhone 13 Pro", spec: "128GB \xB7 6GB RAM", cond: "Refurbished", price: "KSh 78,000" }
  ].map((p) => <div key={p.name} className="card-hover overflow-hidden rounded-2xl border border-border bg-card">
              <div className="bg-gradient-to-b from-secondary to-background">
                <img src={p.img} alt={p.name} loading="lazy" width={800} height={1e3} className="mx-auto aspect-[4/5] w-full object-contain p-6" />
              </div>
              <div className="p-5">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <a
    href={waLink(`Hi! I'm interested in the ${p.name}.`)}
    target="_blank"
    rel="noreferrer"
  ...
  ].map((t) => <figure key={t.n} className="glass rounded-2xl p-6">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-primary p-8 sm:p-12">
          <div className="relative z-10 grid items-center gap-6 lg:grid-cols-[1fr_auto]">
            ...
            <div className="flex flex-wrap gap-3">
              <a
    href={waLink("Hi! I want to check parts availability.")}
    target="_blank"
    rel="noreferrer"
