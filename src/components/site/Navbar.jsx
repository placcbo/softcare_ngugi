...
function Navbar() {
  ...
  return <header
    className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${scrolled ? "glass-strong py-2" : "py-3 bg-transparent"}`}
  >
  ...
  >
      ...
      {open && <div className="glass-strong mx-4 mt-2 rounded-xl p-2 lg:hidden">
