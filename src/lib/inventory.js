...
const BRANDS = ["Samsung", "Apple", "Tecno", "Infinix", "Xiaomi", "Oppo", "Huawei"];
const img = (c) => c === "Cameras" ? cameraImg : c === "Batteries" ? batteryImg : c === "Charging Ports" ? portImg : screenImg;
const make = (id, name, model, brand, category, price, inStock = true) => ({
  id: `p-${id}`,
  name,
  model,
  brand,
...
const PARTS = [
  ...
  make(7, "iPhone 13 OLED Display", "iPhone 13", "Apple", "Screens", 11e3),
  ...
  make(19, "iPhone 12 Battery", "iPhone 12", "Apple", "Batteries", 3e3),
...
const PHONES = [
  { id: "ph-1", name: "Samsung Galaxy S23 Ultra", brand: "Samsung", storage: "256GB", ram: "12GB", condition: "New", price: 145e3, image: phoneS23 },
  { id: "ph-2", name: "Samsung Galaxy A54 5G", brand: "Samsung", storage: "128GB", ram: "8GB", condition: "New", price: 42e3, image: phoneA54 },
  { id: "ph-3", name: "Apple iPhone 13 Pro", brand: "Apple", storage: "128GB", ram: "6GB", condition: "Refurbished", price: 78e3, image: phoneIph },
  { id: "ph-4", name: "Samsung Galaxy S21", brand: "Samsung", storage: "128GB", ram: "8GB", condition: "Refurbished", price: 38e3, image: phoneS21 },
  { id: "ph-5", name: "Samsung Galaxy S22", brand: "Samsung", storage: "256GB", ram: "8GB", condition: "Refurbished", price: 52e3, image: phoneS23 },
