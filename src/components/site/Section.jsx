function Section({
  ...
  return <section className={`mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 ${className}`}>
      {(eyebrow || title || subtitle) && <div className="mx-auto mb-10 max-w-3xl text-center">
