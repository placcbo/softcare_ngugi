...
function ServicesPage() {
  ...
  />
      <Section>
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((i) => <div key={i.t} className="card-hover rounded-2xl border border-border bg-card p-6">
              ...
              <a
    href={waLink(`Hi! I'd like to ask about: ${i.t}.`)}
    target="_blank"
    rel="noreferrer"
  ...
  ].map((b) => <div key={b.t} className="flex items-start gap-3">
